...
public class IMChatListItemAnimator extends DefaultItemAnimator {
...
//    private ChatGreetingsView chatGreetingsView;
    ...
    // 构造函数
    public IMChatListItemAnimator(TgTextChatActivity activity, RecyclerView listView, Theme.ResourcesProvider resourcesProvider) {
        // 设置资源提供者
